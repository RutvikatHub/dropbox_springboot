...
public class UserController {
    ...
    public ResponseEntity<?> getFiles(@RequestBody String payload)
    {
        JSONObject jsonObject = new JSONObject(payload);
        System.out.println(jsonObject);
//        List<Document> list = fileService.getFiles(jsonObject.getString( "document_owner"), jsonObject.getString("document_path"));
